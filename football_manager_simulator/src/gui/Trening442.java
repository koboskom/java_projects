...
public class Trening442 extends JFrame {
    ...
    private JComboBox s4;
    private JButton zatwierdz;
    private JComboBox b1;

    public Trening442(Glowny okno, NowyZarzadanie gui) {
        ...
        zatwierdz.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                Zawodnik c9 = (Zawodnik) s4.getSelectedItem();
                ...
                if (okno.getZarzadzanie().getDruzyna().getPierwszysklad().size() > 11) {
                    ...
                    if (!s1.getSelectedItem().equals(s2.getSelectedItem()) && !s1.getSelectedItem().equals(s3.getSelectedItem()) && !s1.getSelectedItem().equals(s4.getSelectedItem())) {
                    ...
                    if (!s2.getSelectedItem().equals(s1.getSelectedItem()) && !s2.getSelectedItem().equals(s3.getSelectedItem()) && !s2.getSelectedItem().equals(s4.getSelectedItem())) {
                    ...
                    if (!s3.getSelectedItem().equals(s1.getSelectedItem()) && !s3.getSelectedItem().equals(s2.getSelectedItem()) && !s3.getSelectedItem().equals(s4.getSelectedItem())) {
                    ...
                    if (!s4.getSelectedItem().equals(s1.getSelectedItem()) && !s4.getSelectedItem().equals(s3.getSelectedItem()) && !s4.getSelectedItem().equals(s2.getSelectedItem())) {
                        okno.getZarzadzanie().dodajdoskladu((Zawodnik) s4.getSelectedItem());
                    } else {
                        okno.getZarzadzanie().usunzeskladu();
                        JOptionPane.showMessageDialog(trenowanko,
                                "Wybierz innego zawodnika",
