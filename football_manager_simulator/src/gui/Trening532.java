...
public class Trening532 extends JFrame {
    ...
    public Trening532(Glowny okno, NowyZarzadanie gui) {
        ...
        zatwierdz.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                Zawodnik c6 = (Zawodnik) o5.getSelectedItem();
                Zawodnik c7 = (Zawodnik) s1.getSelectedItem();
                Zawodnik c8 = (Zawodnik) s2.getSelectedItem();
                Zawodnik c9 = (Zawodnik) s3.getSelectedItem();
                Zawodnik c10 = (Zawodnik) a1.getSelectedItem();
                Zawodnik c11 = (Zawodnik) a2.getSelectedItem();
                ...
                if (okno.getZarzadzanie().getDruzyna().getPierwszysklad().size() > 11) {
                    ...
                    if (!o1.getSelectedItem().equals(o2.getSelectedItem()) && !o1.getSelectedItem().equals(o3.getSelectedItem()) && !o1.getSelectedItem().equals(o4.getSelectedItem()) && !o1.getSelectedItem().equals(o5.getSelectedItem())) {
                    ...
                    if (!o2.getSelectedItem().equals(o1.getSelectedItem()) && !o2.getSelectedItem().equals(o3.getSelectedItem()) && !o2.getSelectedItem().equals(o4.getSelectedItem()) && !o2.getSelectedItem().equals(o5.getSelectedItem())) {
                    ...
                    if (!o3.getSelectedItem().equals(o1.getSelectedItem()) && !o3.getSelectedItem().equals(o2.getSelectedItem()) && !o3.getSelectedItem().equals(o4.getSelectedItem()) && !o3.getSelectedItem().equals(o5.getSelectedItem())) {
                    ...
                    if (!o4.getSelectedItem().equals(o1.getSelectedItem()) && !o4.getSelectedItem().equals(o3.getSelectedItem()) && !o4.getSelectedItem().equals(o2.getSelectedItem()) && !o4.getSelectedItem().equals(o5.getSelectedItem())) {
                    ...
                    if (!o5.getSelectedItem().equals(o1.getSelectedItem()) && !o5.getSelectedItem().equals(o3.getSelectedItem()) && !o5.getSelectedItem().equals(o2.getSelectedItem()) && !o5.getSelectedItem().equals(o4.getSelectedItem())) {
                        okno.getZarzadzanie().dodajdoskladu((Zawodnik) o5.getSelectedItem());
                    } else {
                        okno.getZarzadzanie().usunzeskladu();
                        JOptionPane.showMessageDialog(trenowanko,
                                "Wybierz innego zawodnika",
                    ...
                    if (!a1.getSelectedItem().equals(a2.getSelectedItem())) {
                    ...
                    if (!a2.getSelectedItem().equals(a1.getSelectedItem())) {
